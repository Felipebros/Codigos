## Não funcionou Instalar TeamViewer 7
...
depois digite o domínio progenbr.com
...
Redigite o domínio progenbr.com
...
chown www-data:desenvolvedor1 -R /var/www/
sudo chown desenvolvedor1:desenvolvedor1 -R /var/www/
sudo chown felipe:felipe -R /var/www/
chown www-data:progen -R /var/www/
# Permissão
...
sudo usermod -G www-data progen
sudo usermod -G desenvolvedor1 www-data
sudo usermod -G adm desenvolvedor1

# teste
sudo usermod -G adm desenvolvedor1
sudo usermod -G cdrom desenvolvedor1
sudo usermod -G sudo desenvolvedor1
sudo usermod -G dip desenvolvedor1
sudo usermod -G plugdev desenvolvedor1
sudo usermod -G lpadmin desenvolvedor1
sudo usermod -G sambashare desenvolvedor1
...
## Usando at
echo "php /home/desenvolvedor1/criar_txt.php" | at now +1 minute
ou
at now +1 minute <<< "php /home/desenvolvedor1/criar_txt.php"
